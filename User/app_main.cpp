...
/* DMA Resources generated by generate_dma_resources() */
static uint8_t spi4_tx_buf[51200] __attribute__((section(".axi_ram")));
static uint8_t spi4_rx_buf[51200] __attribute__((section(".axi_ram")));
...
extern "C" void app_main(void) {
  ...
  STM32SPI spi4(&hspi4, spi4_rx_buf, spi4_tx_buf, 3);
  ...
  LibXR::HardwareContainer peripherals{
    ...
    LibXR::Entry<LibXR::PWM>({pwm_tim1_ch2, {"pwm_tim1_ch2", "st7735_pwm"}}),
